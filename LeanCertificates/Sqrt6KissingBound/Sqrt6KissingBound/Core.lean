...
/-!
# The algebraic core of the `sqrt 6` kissing-number bound

This file contains no `sorry`, `admit`, project-defined axiom, or `native_decide`.
It formalizes the numerical estimates, the parity induction for cap fractions,
and the final cancellation argument. The standard spherical-cap packing theorem
is represented by the explicit hypothesis `hpack` in the final statements.
-/
